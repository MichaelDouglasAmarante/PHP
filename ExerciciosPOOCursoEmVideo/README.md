# PHP - POO - Exercicios do Curso de POO PHP
 Projetos desenvolvidos em PHP durante o Curso de Programação Orientada a Objetos do canal Curso em Vídeo do Youtube.
 
 [*Clique aqui para acessar a Playlist do Curso de POO PHP do Canal **Curso em Vídeo** no Youtube.*](https://www.youtube.com/playlist?list=PLHz_AreHm4dmGuLII3tsvryMMD7VgcT7x)
- [Aula 02 - Criando Classes e Objetos em PHP](https://github.com/MichaelDouglasAmarante/PHP/tree/master/ExerciciosPOOCursoEmVideo/metodosGetterSetterEConstrutor)
